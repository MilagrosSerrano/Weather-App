...
export const WelcomeApp = () => {
  return (
    <div className="welcomeApp">
      <img
        src="src/assets/polar-bear.png"
        alt="polar-bear"
        className="polarBear"
      />
      <h1 id="welcomeTitle">Welcome to Weather Wizards</h1>
      <h2 id="subtitle">Are you tired of not picking the right clothes for the day?</h2>
      <p className="description">We don't know about styling, but we could help you by telling you if you need a coat or not! </p>
      <p className="description">Just type the name of the place where you live, we'll take care of the rest ☺️</p>
>>>>>>> 8e9fae4d720862fc8c582b9f8bfd1ed96a237ddf
